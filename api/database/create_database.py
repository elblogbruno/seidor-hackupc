...
def create_database():
    ...
    cursor.execute('''CREATE TABLE IF NOT EXISTS ItemLocations (
                        ItemLocationID INTEGER PRIMARY KEY,
                        ItemID INTEGER,
                        LocationID INTEGER,
    ...
    for _ in range(10):  # Generate 10 items
        ...
        cursor.execute("INSERT INTO Items (Name, Category, Price) VALUES (?, ?, ?)", (item_name, category, price))
    ...
    for _ in range(3):  # Generate 3 orders
        ...
        cursor.execute("INSERT INTO Orders (UserID, OrderDate, TotalAmount) VALUES (?, ?, ?)", (user_id, order_date, total_amount))
    ...
    for i in range(1, 21):  # Generate 20 locations
        ...
        cursor.execute("INSERT INTO Locations (LocationID, Aisle, Shelf, Bin) VALUES (?, ?, ?, ?)", (i, aisle, shelf, bin_))
    ...
    for item_id in range(1, 11):  # Assuming there are 10 items in the Items table
        ...
        cursor.execute("INSERT INTO ItemLocations (ItemID, LocationID) VALUES (?, ?)", (item_id, location_id))
